...
var planActionsClass = function() {
  ...
  this.list = function() {
    ...
    utility.changeScreen('../../src/views/plan/list.html div#card-body', [getList, response]);
  }
   ...
   */
  this.new = function() {
    utility.changeScreen('../../src/views/plan/form.html div#card-body');
    return "create";
  }
  ...
  this.get = function(id) {
    ...
    form = new planFormClass({
      formData: response
    });
    utility.changeScreen('../../src/views/plan/form.html div#card-body', [form.hidrate]);
  }
  ...
  this.del = function(id) {
    ...
    if (response.response.status == 200) {
      action = 'list';
      utility.changeScreen('../../src/views/plan/list.html div#card-body');
    } else {
      if (id != '') return 'update';
      action = 'create';
    }
